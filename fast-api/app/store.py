...
In a real app this would be an HRMS. Keeping it in one class (no globals) makes
it easy to swap out and easy to test — a test builds its own store and overrides
the dependency, so no test can see another test's shortlist.
"""
